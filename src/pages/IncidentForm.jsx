...
const TYPES = [
  'Ошибка дозирования лекарственного средства',
  'Утрата/хищение медицинского препарата',
  'Просрочка лекарственного препарата',
  'Нарушение правил хранения лекарственных средств',
  'Аллергическая реакция / побочный эффект',
  'Нарушение врачебной тайны / утечка данных',
